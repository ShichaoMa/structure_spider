...
from .utils import xpath_exchange, CustomLoader, re_search, safely_json_loads, enrich_wrapper
from ..items.douban_item import FilmBaseItem, QuestionItem, AnswerItem, ReviewItem
...
class DoubanSpider(StructureSpider):
    ...
    def enrich_data(self, item_loader, response):
        ...
        related_pic_url = response.xpath('//div[@id="related-pic"]/h2/span[@class="pl"]/a/@href').extract()[-2]
        if related_pic_url:
